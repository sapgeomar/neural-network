...
categories = ["calanoids", "eucalanoids"]                                             # name of the folder
...
# lets create the training datasets
training_data = []                                                                    # creating an empty list
def create_training_data():                                                           # defining a function with new array
    for category in categories:
        ...
        for img in os.listdir(path):
            ...
            training_data.append([new_array, class_num])                              # append the empyty list with new array and class number
create_training_data()                                                                # calling the function
#print(len(training_data))                                                            # see the length of the training data
#random.shuffle(training_data)                                                         # give training data a shuffle
...
for features, labels in training_data:                                                # defining and calling image array and category as features and labels
...
pickle_out = open("trainLabel.pickle", "wb")
